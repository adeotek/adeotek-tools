...
Each project has its own root directory and its own `AGENTS.md` file with project-specific build commands, code style, and architecture notes. **Always read the project's own `AGENTS.md` before working on it.**
